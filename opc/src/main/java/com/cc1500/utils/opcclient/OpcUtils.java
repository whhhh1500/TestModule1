...
//    /**写入influxDB时序库**/
//    public static int  HistoryValueIninfluxDB(HashMap<String, ItemVal> HistoryVAL) {
//        List<ItemVal> ItemValList = new ArrayList<ItemVal>( HistoryVAL.values() );
//        BatchPoints batchPoints = BatchPoints
//                .database( "OpcReal" )
//                .consistency( InfluxDB.ConsistencyLevel.ALL )
//                .build();
//        int count = 1;
//        for (ItemVal map : ItemValList) {
//            count++;
//            Point point = Point.measurement( "opc1" )
//                    .tag( "tagname", map.getTagname() )
//                    .tag( "address", "" )
//                    .tag( "type", map.getType().toString() )
//                    .tag( "groupname", map.getGroupname() )
//                    .tag( "infid", map.getInfId().toString() )
//                    .tag( "alm_type", map.getAlm_state() + "" )
//                    .addField( "value", map.getValue() )
//                    .build();
//            batchPoints.point( point );
//        }
//        InfluxDB client = InfluxDBFactory.connect( "http://localhost:8086", "admin1234556", "123456" );
